...
# Frontend server storage path - now using dating_show_env
_project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
fs_storage = os.path.join(_project_root, "dating_show_env", "frontend_service", "storage")

# Environment matrix path - now using dating_show_env
env_matrix = os.path.join(_project_root, "dating_show_env", "frontend_service", "static_dirs", "assets", "the_ville", "matrix")

# Temp storage path - needed for frontend communication
